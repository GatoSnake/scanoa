...
public class ConsultasWrite {
	...
	static private String prefix_xsd = "http://www.w3.org/2001/XMLSchema#";
...
//	        System.out.println(q);
	...
	public static void insertPropertyValueString(String propiedad, String topico, String value){
//		System.out.println("en metodo --> insertProperty()");
	    Dataset dataset = ConexionOntology.ConnectModelForWrite();
	    try{
	        GraphStore graphStore = GraphStoreFactory.create(dataset) ;
	        String q2 = "PREFIX skos: <"+prefix_skos+">\n"
	    			...
	    			+ "PREFIX xsd: <"+prefix_xsd+">\n"
	        		+ "INSERT DATA {"
	    			+ "<"+uri_topico+topico+"> "+propiedad+" '"+value+"'^^ xsd:string ."
	        		+ "}";
//	        System.out.println(q2);
	    	UpdateRequest request = UpdateFactory.create(q2);
	        UpdateProcessor proc = UpdateExecutionFactory.create(request,graphStore);
	...
	//metodo que borra el valor de una propiedad de un topico
	public static void deletePropertyValueString(String propiedad, String topico, String value){
//		System.out.println("en metodo --> insertProperty()");
	    Dataset dataset = ConexionOntology.ConnectModelForWrite();
	    try{
	        GraphStore graphStore = GraphStoreFactory.create(dataset) ;
...
//	        System.out.println(q);
	...
	//metodo que actualiza el valor de una propiedad de un topico
	public static void updatePropertyValueString(String propiedad, String topico, String lastValue, String newValue){
//		System.out.println("en metodo --> updateProperty() to "+topico);
	    Dataset dataset = ConexionOntology.ConnectModelForWrite();
	    try{
	        GraphStore graphStore = GraphStoreFactory.create(dataset) ;
	        String q = "PREFIX ContCompTI: <"+prefix_ContCompTI+">\n"
	    			...
	    			+ "PREFIX xsd: <"+prefix_xsd+">\n"
	        		+ "DELETE DATA {"
	    			+ " <"+uri_topico+topico+"> "+propiedad+" '"+lastValue+"'^^ xsd:string . "
	        		+ "};\n"
	        		+ "INSERT DATA {"
	        		+ " <"+uri_topico+topico+"> "+propiedad+" '"+newValue+"'^^ xsd:string . "
	        		+ "};";
//	        System.out.println(q);
	    	UpdateRequest request = UpdateFactory.create(q);
	        UpdateProcessor proc = UpdateExecutionFactory.create(request,graphStore);
